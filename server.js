...
// ─────────────────────────────────────────────
const MODELS = [
  'liquid/lfm-2.5-1.2b-instruct:free',        // Insanely fast 1.2B model (800ms)
  'google/gemma-4-31b-it:free',               // Smart 31B fallback (3.2s)
  'meta-llama/llama-3.2-3b-instruct:free'     // Backup if rate limits subside
];
